...
*criei um middleware (checkId) adicional para checar se existe ID no body da requisição, caso não existe retorna um status 400, com uma mensagem de erro